...
_CONFIG = {
    "Aurora": dict(total=468, prior_rhoden_share=0.575256),
    "Beadle": dict(total=1993, prior_rhoden_share=0.636895),
    "Bennett": dict(total=337, prior_rhoden_share=0.582872),
    "Bon Homme": dict(total=1098, prior_rhoden_share=0.545231),
    "Brookings": dict(total=4094, prior_rhoden_share=0.6554),
    "Brown": dict(total=6141, prior_rhoden_share=0.605402),
    "Brule": dict(total=865, prior_rhoden_share=0.624657),
    "Buffalo": dict(total=80, prior_rhoden_share=0.6712),
    "Butte": dict(total=2209, prior_rhoden_share=0.624085),
    "Campbell": dict(total=452, prior_rhoden_share=0.571894),
    "Charles Mix": dict(total=1319, prior_rhoden_share=0.64823),
    "Clark": dict(total=950, prior_rhoden_share=0.586493),
    "Clay": dict(total=1193, prior_rhoden_share=0.654384),
    "Codington": dict(total=3784, prior_rhoden_share=0.586539),
    "Corson": dict(total=264, prior_rhoden_share=0.622803),
    "Custer": dict(total=2672, prior_rhoden_share=0.493912),
    "Davison": dict(total=3191, prior_rhoden_share=0.676208),
    "Day": dict(total=936, prior_rhoden_share=0.639406),
    "Deuel": dict(total=991, prior_rhoden_share=0.54622),
    "Dewey": dict(total=316, prior_rhoden_share=0.661557),
    "Douglas": dict(total=1055, prior_rhoden_share=0.661452),
    "Edmunds": dict(total=933, prior_rhoden_share=0.561976),
    "Fall River": dict(total=1816, prior_rhoden_share=0.473357),
    "Faulk": dict(total=791, prior_rhoden_share=0.667403),
    "Grant": dict(total=1304, prior_rhoden_share=0.55588),
    "Gregory": dict(total=1181, prior_rhoden_share=0.636644),
    "Haakon": dict(total=613, prior_rhoden_share=0.659837),
    "Hamlin": dict(total=1644, prior_rhoden_share=0.609528),
    "Hand": dict(total=799, prior_rhoden_share=0.702093),
    "Hanson": dict(total=657, prior_rhoden_share=0.563476),
    "Harding": dict(total=455, prior_rhoden_share=0.658321),
    "Hughes": dict(total=4139, prior_rhoden_share=0.782166),
    "Hutchinson": dict(total=1704, prior_rhoden_share=0.616392),
    "Hyde": dict(total=326, prior_rhoden_share=0.673117),
    "Jackson": dict(total=445, prior_rhoden_share=0.648261),
    "Jerauld": dict(total=345, prior_rhoden_share=0.654354),
    "Jones": dict(total=332, prior_rhoden_share=0.682988),
    "Kingsbury": dict(total=1208, prior_rhoden_share=0.616205),
    "Lake": dict(total=1925, prior_rhoden_share=0.644027),
    "Lawrence": dict(total=5137, prior_rhoden_share=0.633875),
    "Lincoln": dict(total=10218, prior_rhoden_share=0.65085),
    "Lyman": dict(total=601, prior_rhoden_share=0.627008),
    "Marshall": dict(total=725, prior_rhoden_share=0.664552),
    "McCook": dict(total=1287, prior_rhoden_share=0.581486),
    "McPherson": dict(total=821, prior_rhoden_share=0.696711),
    "Meade": dict(total=5714, prior_rhoden_share=0.626527),
    "Mellette": dict(total=230, prior_rhoden_share=0.649617),
    "Miner": dict(total=377, prior_rhoden_share=0.637836),
    "Minnehaha": dict(total=22598, prior_rhoden_share=0.627603),
    "Moody": dict(total=958, prior_rhoden_share=0.587962),
    "Oglala Lakota": dict(total=343, prior_rhoden_share=0.627079),
    "Pennington": dict(total=16218, prior_rhoden_share=0.598787),
    "Perkins": dict(total=832, prior_rhoden_share=0.672649),
    "Potter": dict(total=823, prior_rhoden_share=0.677011),
    "Roberts": dict(total=987, prior_rhoden_share=0.510792),
    "Sanborn": dict(total=325, prior_rhoden_share=0.650622),
    "Spink": dict(total=1115, prior_rhoden_share=0.617905),
    "Stanley": dict(total=1074, prior_rhoden_share=0.724547),
    "Sully": dict(total=483, prior_rhoden_share=0.64824),
    "Todd": dict(total=212, prior_rhoden_share=0.484509),
    "Tripp": dict(total=1603, prior_rhoden_share=0.636861),
    "Turner": dict(total=1777, prior_rhoden_share=0.585254),
    "Union": dict(total=2265, prior_rhoden_share=0.60139),
    "Walworth": dict(total=1085, prior_rhoden_share=0.647687),
    "Yankton": dict(total=3483, prior_rhoden_share=0.647334),
    "Ziebach": dict(total=169, prior_rhoden_share=0.712355),
}
