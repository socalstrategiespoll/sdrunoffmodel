...
_CONFIG = {
    ...
    "Brule": dict(total=824, prior_rhoden_share=0.624657),
    ...
    "Davison": dict(total=3039, prior_rhoden_share=0.676208),
    ...
    "Hanson": dict(total=626, prior_rhoden_share=0.563476),
    ...
    "Jerauld": dict(total=329, prior_rhoden_share=0.654354),
    ...
    "McPherson": dict(total=782, prior_rhoden_share=0.696711),
