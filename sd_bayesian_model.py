...
_CONFIG = {
    ...
    "Bon Homme": dict(total=1046, prior_rhoden_share=0.545231),
    "Brookings": dict(total=3899, prior_rhoden_share=0.6554),
    "Brown": dict(total=5849, prior_rhoden_share=0.605402),
    "Brule": dict(total=713, prior_rhoden_share=0.624657),
    "Buffalo": dict(total=76, prior_rhoden_share=0.6712),
    "Butte": dict(total=2104, prior_rhoden_share=0.624085),
    "Campbell": dict(total=431, prior_rhoden_share=0.571894),
    "Charles Mix": dict(total=1256, prior_rhoden_share=0.64823),
    "Clark": dict(total=905, prior_rhoden_share=0.586493),
    "Clay": dict(total=1136, prior_rhoden_share=0.654384),
    "Codington": dict(total=3604, prior_rhoden_share=0.586539),
    "Corson": dict(total=251, prior_rhoden_share=0.622803),
    "Custer": dict(total=2545, prior_rhoden_share=0.493912),
    "Davison": dict(total=2614, prior_rhoden_share=0.676208),
    "Day": dict(total=892, prior_rhoden_share=0.639406),
    "Deuel": dict(total=944, prior_rhoden_share=0.54622),
    ...
    "Faulk": dict(total=753, prior_rhoden_share=0.667403),
    "Grant": dict(total=1242, prior_rhoden_share=0.55588),
    "Gregory": dict(total=1125, prior_rhoden_share=0.636644),
    "Haakon": dict(total=584, prior_rhoden_share=0.659837),
    "Hamlin": dict(total=1566, prior_rhoden_share=0.609528),
    "Hand": dict(total=761, prior_rhoden_share=0.702093),
    "Hanson": dict(total=528, prior_rhoden_share=0.563476),
    "Harding": dict(total=433, prior_rhoden_share=0.658321),
    "Hughes": dict(total=3942, prior_rhoden_share=0.782166),
    "Hutchinson": dict(total=1623, prior_rhoden_share=0.616392),
    "Hyde": dict(total=311, prior_rhoden_share=0.673117),
    "Jackson": dict(total=424, prior_rhoden_share=0.648261),
    "Jerauld": dict(total=343, prior_rhoden_share=0.654354),
    "Jones": dict(total=316, prior_rhoden_share=0.682988),
    "Kingsbury": dict(total=1151, prior_rhoden_share=0.616205),
    "Lake": dict(total=1834, prior_rhoden_share=0.644027),
    "Lawrence": dict(total=4893, prior_rhoden_share=0.633875),
    "Lincoln": dict(total=9732, prior_rhoden_share=0.65085),
    "Lyman": dict(total=572, prior_rhoden_share=0.627008),
    "Marshall": dict(total=691, prior_rhoden_share=0.664552),
    "McCook": dict(total=1226, prior_rhoden_share=0.581486),
    "McPherson": dict(total=759, prior_rhoden_share=0.696711),
    "Meade": dict(total=5443, prior_rhoden_share=0.626527),
    "Mellette": dict(total=219, prior_rhoden_share=0.649617),
    "Miner": dict(total=359, prior_rhoden_share=0.637836),
    "Minnehaha": dict(total=21524, prior_rhoden_share=0.627603),
    "Moody": dict(total=912, prior_rhoden_share=0.587962),
    ...
    "Roberts": dict(total=940, prior_rhoden_share=0.510792),
    "Sanborn": dict(total=310, prior_rhoden_share=0.650622),
    "Spink": dict(total=1062, prior_rhoden_share=0.617905),
    "Stanley": dict(total=1023, prior_rhoden_share=0.724547),
    "Sully": dict(total=460, prior_rhoden_share=0.64824),
    "Todd": dict(total=202, prior_rhoden_share=0.484509),
    "Tripp": dict(total=1527, prior_rhoden_share=0.636861),
    "Turner": dict(total=1693, prior_rhoden_share=0.585254),
    "Union": dict(total=2157, prior_rhoden_share=0.60139),
    "Walworth": dict(total=1033, prior_rhoden_share=0.647687),
    "Yankton": dict(total=3318, prior_rhoden_share=0.647334),
